...
/**
 * A Score is a structure that stores notes as an 8-tuple: (pitch, velocity,
 * channel, start (ticks), duration (ticks), start (seconds), duration
 * (seconds), track)
 * 
 * Serves as a temporary DTO to transmit between the MidiReader and the
 * ScoreAnalyzer.
 */
public class Score {
	 ...
	 * 
	 * @param Track
	 *            The track number being returned
